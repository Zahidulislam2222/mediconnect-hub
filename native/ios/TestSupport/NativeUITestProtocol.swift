...
enum NativeUITestProtocol {
    ...
    static let settingsPreferencePrefix = "settings-preference-"
    static let patientSettings = "--native-patient-settings-ui-test"
    static let patientSettingsLostReadback = "--native-patient-settings-lost-readback"
